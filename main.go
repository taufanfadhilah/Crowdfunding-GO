...
import (
	...
	webHandler "bwastartup-be/web/handler"
...
func main() {
	...
	trannsactionWebHandler := webHandler.NewTransactionHandler(transactionService)
	...
	router.GET("/transactions", authAdminMiddleware(), trannsactionWebHandler.Index)
